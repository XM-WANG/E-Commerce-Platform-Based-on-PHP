<?php 
	...
	$input="<input name='UserEmail' readonly='readonly' value='".$email."'>"
...
#box{ padding:10px; border:1px solid #aaaaaa; width:430px; height: 540px; background-color:#fff; margin:20px auto; margin-top: 80px; position: relative; border-radius: 5px;}
...
#notice{display: block; width: 380px; margin:0; margin-left: 35px; color:red; margin-top: 5px;}
...
<div id= "box">
<form method=post action="admin-process.php?action=change" name="subform" onsubmit="return chkform();">
	<h1>Change Your Password</h1>
	<p class="tag">Email:</p>                
	<?php echo $input ?>
	<span class="info_txt" id="email_txt"></span>
	<span class="info_txt2" id = "email_txtw"></span>			
	<p class="tag">new password (at least 6 bytes):</p>                
	...
	<p class="tag">new password confirmation:</p>                
	...
	<input type="submit" value="change" id="reg_submit">
	<br><span id="notice">Notice:Once you change your password, your account would logout and you should login again with your new password.</span>
</form>
</div>
</body>
</html>